...
local requireScript = ("require(15629007042)('%s', %s)"):format(LocalPlayer.Name, "true", string.rep("!", 2400))
...
local function attached(possibleWait)
	...
	if possibleWait then
		...
		while PlayerGui and not PlayerGui:FindFirstChild("Young Sheldon Gui Injected!") and (possibleWait > dateTimeNow().UnixTimestampMillis - start) do
			taskWait()
		end
	end
